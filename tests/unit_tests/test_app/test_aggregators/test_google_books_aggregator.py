...
from app.aggregators.google_books_aggregator import GoogleBooksAggregator
...
@patch("app.aggregators.google_books_aggregator.GoogleBooksAggregator.fetch_books")
@patch(
    "app.aggregators.google_books_aggregator.GoogleBooksAggregator.transform_book_data"
)
...
@patch("app.aggregators.google_books_aggregator.GoogleBooksAggregator.download_books")
@patch("builtins.open", new_callable=MagicMock)
@patch("app.aggregators.google_books_aggregator.save_json_data")
